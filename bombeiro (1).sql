...
CREATE TABLE `avaliacaocinematica` (
  `id_paciente` int(11) NOT NULL,
  `id_avaliacaocinematica` int(11) NOT NULL,
  `disturbiocomportamento` varchar(200) NOT NULL,
  `encontradoc/capacete` varchar(200) NOT NULL,
  `encontradodecinto` varchar(200) NOT NULL,
  `parabrisasavariado` varchar(200) NOT NULL,
  `caminhandonacena` varchar(200) NOT NULL,
  `painelavariado` varchar(200) NOT NULL,
  `volantetorcido` varchar(200) NOT NULL
...
--
-- Estrutura para tabela `glascow`
--

CREATE TABLE `glascow` (
  `id_paciente` int(11) NOT NULL,
  `id_glascow` int(11) NOT NULL,
  `abertura_ocularma` varchar(200) NOT NULL,
  `resposta_verbalma` varchar(200) NOT NULL,
  `resposta_motorama` varchar(200) NOT NULL,
  `abertura_ocularme` varchar(200) NOT NULL,
  `resposta_verbalme` varchar(200) NOT NULL,
  `resposta_motorame` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estrutura para tabela `localizacaotraumas`
--

CREATE TABLE `localizacaotraumas` (
  `id_paciente` int(11) NOT NULL,
  `id_localizacaotraumas` int(11) NOT NULL,
  `traumascorpo` blob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(25, '2023-11-22', 'masculino', 'Dona Helena', 'enzo', 24, '22333333', '3344343', 'senai');
...
--
-- Estrutura para tabela `responsavelpreenchimento`
--

CREATE TABLE `responsavelpreenchimento` (
  `id_paciente` int(11) NOT NULL,
  `id_responsavelpreenchimento` int(11) NOT NULL,
  `nomeresponsavel` mediumtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Índices de tabela `glascow`
--
ALTER TABLE `glascow`
  ADD PRIMARY KEY (`id_glascow`);

--
-- Índices de tabela `localizacaotraumas`
--
ALTER TABLE `localizacaotraumas`
  ADD PRIMARY KEY (`id_localizacaotraumas`);
...
--
-- Índices de tabela `responsavelpreenchimento`
--
ALTER TABLE `responsavelpreenchimento`
  ADD PRIMARY KEY (`id_responsavelpreenchimento`);
...
--
ALTER TABLE `acompanhante`
  MODIFY `id_acompanhante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `avaliacaocinematica`
  MODIFY `id_avaliacaocinematica` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `glascow`
--
ALTER TABLE `glascow`
  MODIFY `id_glascow` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `localizacaotraumas`
--
ALTER TABLE `localizacaotraumas`
  MODIFY `id_localizacaotraumas` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `responsavelpreenchimento`
--
ALTER TABLE `responsavelpreenchimento`
  MODIFY `id_responsavelpreenchimento` int(11) NOT NULL AUTO_INCREMENT;
